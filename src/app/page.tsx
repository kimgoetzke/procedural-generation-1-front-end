    ...
    return (
        <main className="flex min-h-screen items-center justify-center">
            <div className="flex flex-col items-center m-3">
                ...
                <p className="w-full pt-4 pb-2 px-2 text-muted-foreground text-left sm:text-center">
                    The web interface for the text-based adventure game.</p>
                <p className="w-full pb-8 px-2 text-muted-foreground text-left sm:text-center">
                    Explore a huge, procedurally generated world, complete quests, and engage in combat to get stronger
                    and gain loot.</p>
