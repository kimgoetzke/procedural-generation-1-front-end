...
import {DisplayInteractions} from "@/app/components/display-interactions";
import {DisplayEncounterSummary} from "@/app/components/display-encounter-summary";
        ...
        case ViewType.ENCOUNTER_SUMMARY:
            return (
                <div className="w-full">
                    <h2 className="text-xl text-gray-400 flex justify-center mb-3">{webResponse.viewType}</h2>
                    <DisplayPlayerBar player={webResponse.player}/>
                    <DisplayEncounterSummary encounterSummary={webResponse.encounterSummary}/>
                    <DisplayActions actions={webResponse.actions}/>
                </div>
            );
        case ViewType.DIALOGUE:
            return (
                <div className="w-full">
                    <h2 className="text-xl text-gray-400 flex justify-center mb-3">{webResponse.viewType}</h2>
                    <DisplayPlayerBar player={webResponse.player}/>
                    <DisplayInteractions interactions={webResponse.interactions}/>
                    <DisplayActions actions={webResponse.actions}/>
                </div>
            );
        default:
